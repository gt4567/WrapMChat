...
#define PACKAGE_STRING "QRencode 3.9.0"/* Define to the one symbol short name of this package. */
...
#define PACKAGE_VERSION "3.9.0"/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1/* Version number of package */
#define VERSION "3.9.0"
#define inline/* Define to 'static' if no test programs will be compiled. */
